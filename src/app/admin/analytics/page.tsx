...
const StatCard: React.FC<StatCardProps> = ({
  ...
  <Card
    className={`p-5 flex justify-between items-center ${colorClass} transition-shadow duration-300 hover:shadow-lg`}
  >
    <div>
        ...
        <div className="p-3 bg-card/90 backdrop-blur-sm border border-border rounded-lg shadow-xl">
          ...
          {payload.map((p, index: number) => (
            <p
              ...
              style={{ color: (p.color as string) || "white" }}
            >
              {(p.name as string) || "Nilai"}:{" "}
        ...
        <main className="pt-24 pb-8 px-8">
          ...
          >
            ...
            <p className="text-foreground/60 mt-2">
              Visualisasi data dan tren analisis SPK TOPSIS
            </p>
          </motion.div>
          ...
          >
            {isLoading ? (
              Array(4)
                .fill(0)
                .map((_, i) => <Skeleton key={i} className="h-[100px]" />)
            ) : summaryData ? (
              <>
                <StatCard
                  title="Total Kosan"
                ...
                <StatCard
                  ...
                  value={
                    summaryData.avgTopsis
                      ? Number(summaryData.avgTopsis).toFixed(4)
                      : "0.0000"
                  }
              ...
              <div className="col-span-4 text-center text-foreground/50 p-4">
